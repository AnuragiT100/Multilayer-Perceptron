...
# Try importing TensorFlow and related modules
try:
...
# Sample data and label encoding
...
# Build and train the model if TensorFlow is available
if tf_available:
    model = Sequential([
    ...
    st.warning("TensorFlow is not installed. The model cannot be trained or used for predictions.")
...
if tf_available and model is not None:
    ...
    st.warning("Prediction is unavailable because TensorFlow is not installed.")
